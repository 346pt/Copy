...
public class Program
{
    ...
    {
        string src1 = @"C:\Пользователи\User\Рабочий стол\file1.txt";
        ...
        timer.Start();
        string dest1 = @"C:\Пользователи\User\Рабочий стол\copy1.txt";
        File.Copy(src1, dest1);
        string src2 = @"C:\Пользователи\User\Рабочий стол\file2.txt";
        string dest2 = @"C:\Пользователи\User\Рабочий стол\copy2.txt";
        ...
        timer.Start();
        th.Start();
        string src = @"C:\Пользователи\User\Рабочий стол\file1.txt";
        string dest = @"C:\Пользователи\User\Рабочий стол\copy3.txt";
        File.Copy(src, dest);
        timer.Stop();
    ...
    {
        string src = @"C:\Пользователи\User\Рабочий стол\file2.txt";
        string dest = @"C:\Пользователи\User\Рабочий стол\copy4.txt";
        File.Copy(src, dest);
    }
}
